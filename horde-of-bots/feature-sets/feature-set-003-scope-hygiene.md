...
## Tickets
- HB-048 — Scope, dependency, and LLM guardrails in CHANGEMATE.md
- HB-049 — Consolidate change-mate footprint into change-mate/ folder
- HB-050 — setup.sh writes deploy-ignore defaults for change-mate/
