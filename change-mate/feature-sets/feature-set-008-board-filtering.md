...
## Tickets
- CM-069 — Filter and sort controls on the board (done 2026-04-29)

## Status
In progress — v1 shipped in CM-069. Future work in this set: search-by-text, filter-by-assignee, saved filter presets (each as its own ticket if pulled).
